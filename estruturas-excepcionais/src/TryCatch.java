...
public class TryCatch {
    ...
    // cometer durante a
    // execução do programa ex: digitar um número no lugar de uma string ou vice
    // versa
    ...
    // finally - permite a defiição de um bloco a ser executado, com ou sem "erros"
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            scanner.close();
        } //o bloco de código CATCH vai executar a ação perante um erro
